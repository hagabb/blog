...
!
!  Content:
!     Implement image segmentation using OpenMP target offload
!
! Compile for CPU without OpenMP:
!     ifx -free img_seg_omp_target.F90 -o img_seg_cpu
!
! Compile for CPU with OpenMP:
!     ifx -free -qopenmp img_seg_omp_target.F90 -o img_seg_omp_cpu
!
! Compile for GPU using the OpenMP backend:
!     ifx -free img_seg_omp_target.F90 -o img_seg_omp_gpu \
